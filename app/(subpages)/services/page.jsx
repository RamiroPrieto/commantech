  ...
  return (
    <div className='container'>
      ...
      <div className="servicesI__grid">
          ...
          <ServiceTextBox image="/iso.svg" title="Potencial constituents and tooling" text="Searching for adequate constituent materials is not always an easy task if you want to try with non conventional composite materials. Gaining confidence in new materials developed in the market will let you offer novel designs. We can find out the best cost/performance ratio constituents as well as the right tooling equipment for building your composite part." />
          <ServiceTextBox image="/incrementar1.svg" title="Process quality control monitoring" text="Knowing when a part is well made or within the margins accepted in the industry is a crucial point. From COMMANTECH we can transfer knowledge to your company giving you the tools and good understanding to make a proper quality control." />
