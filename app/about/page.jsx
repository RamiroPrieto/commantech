  ...
  return (
    <div className={styles.splitted}>
        <div className={styles.leftPanel}>
            <h2>COMMANTECH</h2>
            <br/>
            <p>The use of new renewable composite materials helps to counterbalance the extensive use of petroleum-based polymers used today. Hence, the industry is investing too much effort on applying them in their products.

            We focus on linking these new market trends with the marine industry. Therefore, the main purpose of COMMANTECH is to provide the necessary elements you need in your shipyard to learn how to manufacture and take control of new composite materials and why not to develop a specific one to your requirements.</p>
            <br/>
